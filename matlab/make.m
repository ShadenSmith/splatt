...
function make
  ...
  case 'MACI64'
      ...
      -lsplatt -lgomp -lm
      mex splatt_ttm.c -I../include -L../build/Darwin-x86_64/lib ...
      -lsplatt -lgomp -lm
  ...
  case 'GLNXA64'
    ...
    mex splatt_mttkrp.c -I../include -L../build/Linux-x86_64/lib ...
        -lsplatt -lgomp -lm
    mex splatt_ttm.c -I../include -L../build/Linux-x86_64/lib ...
        -lsplatt -lgomp -lm
  ...
  case 'GLNX32'
      ...
      mex splatt_mttkrp.c -I../include -L../build/Linux-x86/lib ...
          -lsplatt -lgomp -lm
      mex splatt_ttm.c -I../include -L../build/Linux-x86/lib ...
          -lsplatt -lgomp -lm
  end
